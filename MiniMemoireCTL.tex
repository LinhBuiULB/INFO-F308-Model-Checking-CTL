...
\footnotetext{Source: Wikipedia, "Vérifications de modèles" - https://fr.wikipedia.org/wiki/Vérification\_de\_modèles}
...
Afin d'illustrer les algorithmes abordés, une exécution de chaque algorithme sur les 3 premiers nvieaux (0,1,2) de la modélisation du problème de distributeur de boissons va être présentée. 
